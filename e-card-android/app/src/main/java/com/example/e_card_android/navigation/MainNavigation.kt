...
import com.example.e_card_android.ui.main.homescreen.HomeScreen
import com.example.e_card_android.ui.main.notification.NotificationScreen
...
fun MainNavigation(navController: NavHostController, innerPadding: PaddingValues) {
    NavHost(navController = navController, startDestination = Routes.HOME.value) {
        ...
        composable(Routes.NOTIFICATIONS.value) {
            NotificationScreen(paddingValues = innerPadding)
        }
    }
}